...
sound.Add({
	...
	pitch = {100,100},
	sound = {
		"kyo/mwii/mcharliebraavorttle/weap_ar_mcharlie_selector_off.wav",
		}
})
-- Sound: 45
sound.Add({
	...
	pitch = {100,100},
	sound = {
		"kyo/mwii/mcharliebraavorttle/weap_ar_mcharlie_selector_on.wav",
		}
})
-- Sound: 46
sound.Add({
	name = "weap_mpapax_inspect_boltpull",
	channel = CHAN_WPNFOLEY + 1,
...
-- Sound: 47
sound.Add({
	name = "weap_mpapax_inspect_boltclose",
	channel = CHAN_WPNFOLEY + 2,
