...
if CLIENT then
    killicon.Add( "mg_mcbravo", "VGUI/entities/mg_mcbravo", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/entities/mg_mcbravo_killicon")
end
...
SWEP.Trigger = {
    PressedSound = Sound("weap_ar_mcbravo_released"),
    ReleasedSound = Sound("weap_ar_mcbravo_disconnector"),
    Time = 0.025
}

SWEP.Primary.Sound = Sound("weap_mcbravo_fire_plr_shot")
