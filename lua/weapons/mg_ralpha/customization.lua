...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_mcharlie_sup_plr_shot_01")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
                Layer = Sound("weap_ar4_sup_fire_plr_atmo_ext1_01"),
                Reflection = Sound("")
            },
...
SWEP.Customization = {
    ...
    {"attachment_vm_ar_ralpha_barrel", "attachment_vm_ar_ralpha_barmed", "attachment_vm_ar_ralpha_barlong", "attachment_vm_ar_ralpha_barshort"},

    {"attachment_vm_ar_ralpha_stock", "attachment_vm_sm_mpapax_stockl", "attachment_vm_sm_mpapax_stockno", "attachment_vm_sm_mpapax_stocktac", "attachment_vm_ar_mcharlieb_stock", "attachment_vm_ar_ralpha_stockno"},

    {"attachment_vm_sm_ralpha_pistgrip", "attachment_vm_sm_mcbravo_pistgrip", "attachment_vm_sm_mpapax_pistgrip", "attachment_vm_sm_mcharlieb_pistgrip", "attachment_vm_jup_cp08_br_xmike5_pgrip"},

    {"attachment_vm_ar_ralpha_mag", "attachment_vm_ar_mcbravo_smags", "attachment_vm_ar_ralpha_xmag", "attachment_vm_ar_ralpha_xmaglrg"},
